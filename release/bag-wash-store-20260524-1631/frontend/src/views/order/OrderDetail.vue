...
import { getStatusLabel } from '../../constants/order'
...
onMounted(() => {
  serviceStore.fetchList({ page: 1, pageSize: 100 }).catch(() => {})
  loadOrder()
})
        ...
        <el-col :xs="24" :lg="10">
          <el-card shadow="never" class="block">
            ...
            <el-descriptions :column="1" border>
              <el-descriptions-item label="洗护项目">{{ serviceStore.getWashServiceLabels(order.washServices) }}</el-descriptions-item>
